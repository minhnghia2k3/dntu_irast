...
function Admin() {
    ...
    const [imageInputs, setImageInputs] = useState([<input key={0} type="file" />]); // Sử dụng useState để quản lý danh sách các input fields cho hình ảnh
    ...
    const addImageInput = () => {
        // Thêm một input field hình ảnh mới vào danh sách
        const newIndex = imageInputs.length;
        const newInput = <input key={newIndex} type="file" />;
                                ...
                                <tbody>
                                    {companies && companies.map((company, index) => (
                                        <tr key={index} className="border-b dark:border-gray-700 h-full">
                                            <td scope="row" className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{company.company_name}</td>
                                            <td className="px-4 py-3">{company.address}</td>
                                            <td className="px-4 py-3">{company.phone}</td>
                                            <td className="px-4 py-3 max-w-[12rem] truncate">{company.description}</td>
                                            <td className="px-4 py-3">{company.websiteUrl}</td>
                                            ...
                                            <td className="px-4 py-3">
                                                {company.videos && company.videos.map((video, index) => (
                                                    // if length > 3 show 3 videos ... else < 3 show all
                                                    index < 1 ?
                                ...
                                <form action="#">
                                    <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" maxLength="12" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Nhập số điện thoại " required="" />
                                        </div>
                                        <div><label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category</label><select id="category" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"><option selected="">Select category</option><option value="TV">TV/Monitors</option><option value="PC">PC</option><option value="GA">Gaming/Console</option><option value="PH">Phones</option></select></div>
                                        {
                                        ...
                                        <button onClick={addImageInput}>Thêm hình ảnh</button>

                                        <div className="sm:col-span-2"><label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mô tả</label><textarea id="description" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Mô tả về sản phẩm của công ty"></textarea></div>
                                    </div>
                                    <button type="submit" className="flex items-center justify-center text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                                        Thêm mới
                                    </button>
                                </form>
                            </div>
